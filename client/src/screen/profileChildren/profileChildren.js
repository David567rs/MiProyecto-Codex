        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, padding: 10, alignItems: 'center', paddingBottom: 100 }}>
            <View style={{
                ...
                <View style={{ width: '100%', paddingVertical: 10 }}>
                    ...
                    <ListItem onPress={() => navigation.navigate('dentalcontrol', { children })} containerStyle={{ backgroundColor: 'transparent', paddingVertical: 5 }}>
                        <Image source={require('../../../assets/icons/icons8-bebé-80.png')} style={{ width: 30, height: 30 }} />
                        <ListItem.Content>
                            <ListItem.Title>Control dental</ListItem.Title>
                        </ListItem.Content>
                        <ListItem.Chevron color='#48A2E2' size={30} />
                    </ListItem>
